/**
 * This can all be refactored into folders:
 * src
 *  > app (containing app.js and store.js)
 *  > features (containging a seperate folder for each of allRecipes, favoriteRecipes and searchTerm)
 *   
 */
